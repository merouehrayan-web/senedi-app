...
import { Home, CalendarPlus, Images, Star, Wrench } from "lucide-react";
...
const TABS = [
  ...
  { id: "confiance" as Tab, label: "Références", icon: Star },
        ...
        {TABS.map(({ id, label, icon: Icon }) => {
          ...
          return (
            ...
            >
              ...
              <span className={`text-[10px] font-medium transition-colors ${active ? "text-gold" : "text-white/40"}`}>
                {label}
              </span>
            </button>
          );
